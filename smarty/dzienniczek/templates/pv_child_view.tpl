...
{/block}
{block name=body}
<a href="{$SCRIPT_NAME}?action=timetable&id={$who}"><div class="radius" id="btn1" style="float:left"> <p align="center"> <img src="images/lesson_plan.png" align="middle"  /><br/>Plan lekcji</p> </div> </a>
    <a href="{$SCRIPT_NAME}?action=marks&id={$who}"><div class="radius" id="btn2" style="float:left"> <p align="center"> <img src="images/marks.png" align="middle"  /><br/>Oceny</p> </div> </a>
