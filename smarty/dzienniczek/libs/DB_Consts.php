<?php
	...
	class DB_Consts
	{
		...
		static $GET_STUDENT_DATA = 'SELECT name, surname, email, tel from students where login=\'';
		static $GET_PARENT_DATA = 'SELECT name, surname, email, tel from parents where login=\'';
		static $GET_TEACHER_DATA = 'SELECT name, surname, email, tel from teachers where login=\'';
